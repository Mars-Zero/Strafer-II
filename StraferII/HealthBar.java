...
/**
 * Class Bar: for use as a health bar or progress bar as well as for other types
 * of measurements for visual of value in a bar form DO NOT EDIT THIS CLASS as
 * everything can be controlled through method calls.
 */
...
//  The color of the bar AT the breakpoint will be the average color between the safe color and the danger color
     ...
     * of the bar and calls the 'newImage' method to build and set a new image
     * for the bar.
     *
     * @param 'refText': a text string to specify what the bar is for (be
     * specific enough so that all bars can be distinguished one from another)
     * @param 'unitType': a text string to specify what measure is being used in
     * the bar ("percentage", "points", "frames per second", or whatever)
    ...
    /**
     * Method 'newImage': builds a new image for the bar, determined by the
     * values set for it
     */
    ...
    /**
     * Method 'add': add an amount to the value of the bar, checks to make sure
     * the new value is between minimumValue and maximumValue, then, calls
     * 'newImage' to build and set the new image for the bar.
     *
     * @param 'amount': the amount to add (if not negative) or subtract (if
     * negative) to the current value of the bar
     */
    ...
    /**
     * Method 'subtract': subtracts an amount from the value of the bar, checks
     * to make sure the new value does not overstep its bounds, then, calls
     * 'newImage' to build and set the new image for the bar.
     *
     * @param 'amount': the amount to subtract (if positive) or add (if
     * negative) to the current value of the bar
     */
    ...
    /**
     * Method 'checkValue': ensures that the new value in between the minimum
     * value and the maximum value for the bar
     */
    ...
    /**
     * Method 'getBarWidth': returns the current width of the bar (color portion
     * only)
     *
    ...
    /**
     * Method 'getBarHeight': returns the current height of the bar (color
     * portion only)
     *
    ...
    /**
     * Method 'getBreakPercent': returns the range percent at which the color of
     * the bar changes between lower values and higher values (the variable
     * 'usingBreakValue' must be 'false' for percent breaking is to be active;
     * using 'setBreakPercent' will automatically set 'usingBreakValue' to
     * 'false'.
     *
     * @return: the percent value that determines where the color of the bar
     * will change
     */
    ...
    /**
     * Method 'getBreakValue': returns the current value at which the color of
     * the bar will change (the variable 'usingBreakValue' must be 'true' for
     * value breaking is to be active; using 'setBreakValue' will automatically
    ...
    /**
     * Method 'getBreakLow': returns the boolean value that determines if the
     * danger color is used at the low end or the high end of the range (setting
     * it to 'minimumValue' or 'maximumValue' will essentially deactivate
     * breaking)
     *
     * @return: the break state (danger color for low values when true) of the
     * bar
     */
    ...
    /**
     * Method 'getBackgroundColor': returns the current background color of the
     * image for the bar
     *
     * @return: the current color used for the background of the bar image
     * (behind the bar and the text, alike)
     */
    ...
    /**
     * Method 'getSafeColor': returns the current color used for values above
     * any break point, if 'breakLow' is 'true', else below
     *
     * @return: the current color of the color portion of the bar used for
     * 'safe' values
     */
    ...
    /**
     * Method 'getDangerColor': returns the current color used for values below
     * any break point, if 'breakLow' is 'true' else above
     *
     * @return: the current color of the color portion of the bar used for
     * 'danger' values
     */
    ...
    /**
     * Method 'getFontSize': returns the current font size for the text used in
     * the bar image
     *
    ...
    /**
     * Method 'getReferenceText': returns the string set as the title text of
     * the bar
     *
    ...
    /**
     * Method 'getUnitOfMeasure': returns the current string used to qualify the
     * value of the bar
     *
    ...
    /**
     * Method 'getShowTextualUnits': returns the current state of showing/hiding
     * of the textual value and unit of measure of the bar
     *
     * @return: the current state of showing/hiding of the string representation
     * of the value and unit of measure on the right side of the bar
     */
    ...
    /**
     * Method 'setBreakPercent': sets a new percentage value where the bar
     * changes colors between safe and danger values (if set to zero or one
     * hundred, the bar will stay a constant color) 'usingBreakValue' will be
     * automatically set to 'false' when this method is called
     *
     * @param 'percent': the new percentage in the range of allowable values in
     * the bar at which the color of the bar changes between 'safeColor' and
     * 'dangerColor'
     */
    public void setBreakPercent(int percent) {
        if (percent >= 0 && percent <= 100) {
            breakPercent = percent;
            usingBreakValue = false;
            newImage();
        }
    }

    /**
     * Method 'setBreakValue': sets a new value for where the color of the color
     * portion of the bar will change between safe and danger values (if set to
     * minimumValue or maximumValue, the bar will stay a constant color)
     * 'usingBreakValue' will be automatically set to 'true' when this method is
     * called
     *
     * @param 'brkVal': the new value where the color of the color portion of
     * the bar will change between 'safeColor' and 'dangerColor'
     */
    public void setBreakValue(int brkVal) {
        if (brkVal >= minimumValue && brkVal <= maximumValue) {
            breakValue = brkVal;
            usingBreakValue = true;
            newImage();
        }
    }

    /**
     * Method setBreakLow: sets the direction of safe to danger values; true:
     * danger values are low and safe values are high; false: danger values are
     * high ...
     *
    ...
    /**
     * Method 'setBackgroundColor': sets a new color to use behind the text and
     * bar of the image
     *
     * @param 'color': the new color to use for the background color of the bar
     * image
     */
    ...
    /**
     * Method 'setTextColor': sets a new color for the text and frame of the bar
     * image
     *
    ...
    /**
     * Method 'setSafeColor': sets a new color for the color portion of the bar
     * for safe values
     *
     * @param 'color': the new color for safe values in the color portion of the
     * bar
     */
    ...
    /**
     * Method 'setDangerColor': sets a new color for the color portion of the
     * bar for danger values
     *
     * @param 'color': the new color for danger values in the color portion of
     * the bar
     */
    ...
    /**
     * Method 'setFontSize': sets the font size to use for all text in the bar
     * image
     *
    ...
    /**
     * Method 'setMaximumValue': sets a new maximum for allowable values for the
     * bar
     *
    ...
    /**
     * Method 'setMinimumValue': sets a new minimum for allowable values for the
     * bar
     *
    ...
    /**
     * Method 'setShowTextualUnits': sets the state of showing/hiding of the
     * textual value and unit of measure on the right side of the bar
     *
     * @param 'show': the new state of showing/hiding of value text for the bar
     */
    public void setShowTextualUnits(boolean show) {
        showTextualUnits = show;
        newImage();
    }
}
